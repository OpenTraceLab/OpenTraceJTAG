...
import (
	...
	kicadpcb "github.com/OpenTraceLab/OpenTraceJTAG/pkg/kicad/pcb"
...
func (a *App) isJTAGCandidate(fp *kicadpcb.Footprint) bool {
...
func (a *App) loadBoardFile(filepath string) {
	board, err := kicadpcb.ParseFile(filepath)
	if err != nil {
